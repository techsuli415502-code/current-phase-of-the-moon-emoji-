...
const FAQS = [
  {
    ...
    a: "The exact emoji shown at the top of this page is computed live, in your browser, for the precise moment you loaded it. The Moon cycles through eight canonical phases — 🌑 New Moon, 🌒 Waxing Crescent, 🌓 First Quarter, 🌔 Waxing Gibbous, 🌕 Full Moon, 🌖 Waning Gibbous, 🌗 Last Quarter, and 🌘 Waning Crescent — and the one displayed above corresponds to where the Moon is right now in that 29.53-day cycle.",
  },
  {
  ...
  },
  {
    ...
    a: "Absolutely. Every emoji on this site is a standard Unicode character, which means it works in tweets, text messages, emails, calendar entries, and journal apps without any special software. Just select the emoji at the top of the page and copy it like any other text.",
  },
  {
    ...
    <section id="faq" className="px-4 py-20 sm:px-6">
      <div className="mx-auto max-w-3xl">
        <SectionHeading
          ...
          subtitle="Quick, no-nonsense answers to the questions visitors ask us most often. If you have a question that isn't covered here, please reach out through the contact section."
        />
